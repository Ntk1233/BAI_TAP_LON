<template>
    <div class="wrapper-controls">
        <button 
            v-on:click="newGame"
            class="control btn-new"><i class="ion-ios-plus-outline"></i>TRO CHOI MOI</button>
        <button 
            v-on:click="rollDice"
            class="control btn-roll"><i class="ion-ios-loop"></i>TUNG XUC XAC</button>
        <button 
            v-on:click="$emit('handleHoldScore')"
            class="control btn-hold"><i class="ion-ios-download-outline"></i>LAY DIEM</button>
