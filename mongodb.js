...
var url = "mongodb+srv://kha123:kha123456@cluster0.0ajp8.mongodb.net/BAITAPLON?retryWrites=true&w=majority";
...
mongo.connect((err, db) => {
    ...
    dbo.createCollection("person" , (err , res)=>{
     ...
     var obj = { name: 'vo thi cam', age: 21 };
